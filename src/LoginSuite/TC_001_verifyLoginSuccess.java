...
public class TC_001_verifyLoginSuccess {
	...
	public void Login() {
		...
		// input username
		driver.findElement(By.xpath("//input[@id='loginEmail']")).sendKeys("vietvan@gmail.com");
		// input pwd
		...
		//compare text after login success
		String expectedMSg = "Logout";
		String actualMsg = driver.findElement(By.xpath("//body/div[1]/nav[1]/div[2]/div[2]/div[1]/ul[1]/li[5]/a[1]")).getText();
